...
- **Kullanılabilirlik:** Renk + metin legend; Leaflet P2.
- **MVP notu:** As-built `/farms/[id]/twin` — şematik/sınırlı viz; Leaflet/uydu yok.
...
2. Recharts / Leaflet (F15/F13 zenginleştirme) — P1/P2.
3. Ortak `SourceBadge` bileşenine konsolidasyon (metin rozetleri as-built’te dağınık).
4. Canlı URL / deploy ve sunum provası.
