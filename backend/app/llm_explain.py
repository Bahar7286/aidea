        ...
        "messages": [
            {
                ...
                "content": (
                    ...
                    "veya uydu iddiası yazma. Kullanıcının kayıtlı gübre/ilaç sınıflarını ve özellikle "
                    "SON GÜBRE / SON İLAÇ işaretlerini yalnızca nem, sulama, EC/tuzluluk ve veri "
                    "kalitesi bağlamında yorumla "
